...
type SupplyChainTabSection = {
  id: string;
  labelKey: string;
};

type SupplyChainSectionTabsProps = {
  sections: SupplyChainTabSection[];
  labels: Record<string, string>;
  activeId: string;
  onChange: (id: string) => void;
};

export function SupplyChainSectionTabs({
  sections,
  labels,
  activeId,
  onChange,
}: SupplyChainSectionTabsProps) {
  return (
