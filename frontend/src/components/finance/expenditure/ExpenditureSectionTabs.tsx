...
import type { ExpenditureSection } from "@/constants/expenditure-pages";
import { cn } from "@/lib/cn";

type ExpenditureSectionTabsProps = {
...
export function ExpenditureSectionTabs({
  sections,
  labels,
  activeId,
  onChange,
}: ExpenditureSectionTabsProps) {
  return (
