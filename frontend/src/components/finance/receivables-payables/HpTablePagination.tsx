...
import { HP_PER_PAGE_OPTIONS } from "@/types/hutang-piutang";
import { ChevronLeft, ChevronRight } from "lucide-react";

type HpTablePaginationProps = {
  page: number;
  lastPage: number;
  perPage: number;
  totalRows: number;
...
export function HpTablePagination({
  page,
  lastPage,
  perPage,
  totalRows,
