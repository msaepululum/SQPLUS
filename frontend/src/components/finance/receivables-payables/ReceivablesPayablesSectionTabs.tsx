...
import type { ReceivablesPayablesSection } from "@/constants/receivables-payables-pages";
import { cn } from "@/lib/cn";

type ReceivablesPayablesSectionTabsProps = {
...
export function ReceivablesPayablesSectionTabs({
  sections,
  labels,
  activeId,
  onChange,
}: ReceivablesPayablesSectionTabsProps) {
  return (
