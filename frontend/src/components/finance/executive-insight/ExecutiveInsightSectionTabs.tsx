...
import type { ExecutiveInsightSection } from "@/constants/executive-insight-pages";
import { cn } from "@/lib/cn";

type ExecutiveInsightSectionTabsProps = {
...
export function ExecutiveInsightSectionTabs({
  sections,
  labels,
  activeId,
  onChange,
}: ExecutiveInsightSectionTabsProps) {
  return (
