...
import type { AccountingSection } from "@/constants/accounting-pages";
import { cn } from "@/lib/cn";

type AccountingSectionTabsProps = {
...
export function AccountingSectionTabs({
  sections,
  labels,
  activeId,
  onChange,
}: AccountingSectionTabsProps) {
  return (
