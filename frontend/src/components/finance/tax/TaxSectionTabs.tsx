...
import type { TaxSection } from "@/constants/tax-pages";
import { cn } from "@/lib/cn";

type TaxSectionTabsProps = {
  sections: TaxSection[];
...
export function TaxSectionTabs({ sections, labels, activeId, onChange }: TaxSectionTabsProps) {
  return (
