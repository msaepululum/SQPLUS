...
type ProcurementTabSection = {
  id: string;
  labelKey: string;
};

type ProcurementSectionTabsProps = {
  sections: ProcurementTabSection[];
  labels: Record<string, string>;
  activeId: string;
  onChange: (id: string) => void;
};

export function ProcurementSectionTabs({
  sections,
  labels,
  activeId,
  onChange,
}: ProcurementSectionTabsProps) {
  return (
